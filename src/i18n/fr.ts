...
export const fr = {
  ...
  contact: {
    ...
    fields: {
      ...
      canton: {
        ...
        options: [
          ...
          { value: 'other-ch', label: 'Autre canton suisse' },
          { value: 'france', label: 'France' },
          { value: 'other', label: 'Autre pays' },
        ],
      },
      symptoms: {
        label: 'Ce qui vous amène',
        optional: '(facultatif, plusieurs choix possibles)',
        help: 'Ces indications nous aideront à mieux préparer votre accompagnement.',
        options: [
    ...
    success: {
      ...
      title: 'Merci {firstname}, votre place est ',
      titleEm: 'réservée.',
      ...
      signatureName: 'Adner',
      signatureRole: 'Dr Adner Neyret · Fondateur',
...
// Type souple pour permettre des traductions différentes par langue
export type Translation = {
  [K in keyof typeof fr]: K extends 'meta'
  ? { [P in keyof typeof fr.meta]: string }
  : typeof fr[K];
};